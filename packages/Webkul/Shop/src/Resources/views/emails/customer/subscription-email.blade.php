@component('shop::emails.layouts.master')
    ...
    <div>
        ...
        <div  style="font-size:16px; color:#242424; font-weight:600; margin-top: 60px; margin-bottom: 15px">
            Welcome to BuyJapan - Email Subscription
        </div>

        <div>
            Thanks for putting me into your inbox. It’s been a while since you’ve read BuyJapan
            emails, and we don’t want to overwhelm your inbox. If you still do not want to receive
